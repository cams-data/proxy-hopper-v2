...
class Mutation:
    ...
    async def add_target(self, info: Info[Context, None], input: TargetInput) -> TargetType:
        from proxy_hopper.auth import Permission
        from proxy_hopper.config import TargetConfig
        from proxy_hopper.repository import _resolve_pool_ips
    ...
    async def update_target(self, info: Info[Context, None], input: TargetInput) -> TargetType:
        from proxy_hopper.auth import Permission
        from proxy_hopper.config import TargetConfig
        from proxy_hopper.repository import _resolve_pool_ips
        require_permission(info, Permission.write)
    ...
    async def remove_target(self, info: Info[Context, None], name: str) -> bool:
        from proxy_hopper.auth import Permission
        require_permission(info, Permission.write)
    ...
    async def add_pool(self, info: Info[Context, None], input: IpPoolInput) -> IpPoolType:
        from proxy_hopper.auth import Permission
        require_permission(info, Permission.write)
    ...
    async def update_pool(self, info: Info[Context, None], input: IpPoolInput) -> IpPoolType:
        from proxy_hopper.auth import Permission
        require_permission(info, Permission.write)
        pool = pool_input_to_model(input)
    ...
    async def remove_pool(self, info: Info[Context, None], name: str) -> bool:
        from proxy_hopper.auth import Permission
        require_permission(info, Permission.write)
    ...
    async def add_provider(self, info: Info[Context, None], input: ProviderInput) -> ProviderType:
        from proxy_hopper.auth import Permission
        require_permission(info, Permission.write)
    ...
    async def update_provider(self, info: Info[Context, None], input: ProviderInput) -> ProviderType:
        from proxy_hopper.auth import Permission
        require_permission(info, Permission.write)
        provider = provider_input_to_model(input)
    ...
    async def remove_provider(self, info: Info[Context, None], name: str) -> bool:
        from proxy_hopper.auth import Permission
        require_permission(info, Permission.write)
