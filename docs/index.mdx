...
<img src="/images/diagram-light.svg" alt="Proxy Hopper architecture" className="block dark:hidden" style={{width: "100%", borderRadius: "12px", margin: "24px 0"}}/>
<img src="/images/diagram-dark.svg" alt="Proxy Hopper architecture" className="hidden dark:block" style={{width: "100%", borderRadius: "12px", margin: "24px 0"}}/>
